...
function T(...e) {
  ...
  const l = [],
    ...
    g = (d, c, w, h) => (d.addEventListener(c, w, h), () => d.removeEventListener(c, w, h)),
    y = I(
      () => [F(r), L(a)],
      ([d, c]) => {
        i(), d && l.push(...t.flatMap((w) => o.map((h) => g(d, w, h, c))));
      },
...
function de(e, r, t, o = {}) {
  ...
  const m = L(r),
    ...
    { pause: C, resume: O } = ee(p, () => u(p.value), { flush: l, deep: i, eventFilter: w });
  return c && g && (T(c, 'storage', _), T(c, J, M)), _(), p;
  function u(n) {
    try {
  ...
  function b(n) {
    ...
    if (s == null) return y && m !== null && t.setItem(e, S.write(m)), m;
    if (!n && v) {
      const f = S.read(s);
...
var me = Object.defineProperty,
  ...
  ye = (e, r) => {
    for (var t in r || (r = {})) ge.call(r, t) && H(e, t, r[t]);
    if (R) for (var t of R(r)) he.call(r, t) && H(e, t, r[t]);
    return e;
  };
function _e(e = {}) {
  const {
    ...
    c = ye({ auto: '', light: 'light', dark: 'dark' }, e.modes || {}),
    w = pe({ window: a }),
    h = $(() => (w.value ? 'dark' : 'light')),
    p = y || (i == null ? X(o) : de(i, o, l, { window: a, listenToStorageChanges: g })),
    m = $(() => (p.value === 'auto' ? h.value : p.value)),
    A = B('updateHTMLAttrs', (u, b, M) => {
  ...
  I(m, C, { flush: 'post', immediate: !0 }), k(() => C(m.value));
  const O = $({
    get() {
  ...
  try {
    return Object.assign(O, { store: p, system: h, state: m });
  } catch (u) {
    return O;
  }
}
