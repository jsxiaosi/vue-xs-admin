...
import { j as kt, J as Rt, b$ as Bt, u as Ht } from './index-nnTfcizh.js';
/**!
 * Sortable 1.15.0
...
var V = $(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  Oe = $(/Edge/i),
  ct = $(/firefox/i),
  ye = $(/safari/i) && !$(/chrome/i) && !$(/android/i),
  Et = $(/iP(ad|od|hone)/i),
...
function p(n, e) {
  ...
  (this.el = n), (this.options = e = q({}, e)), (n[Y] = this);
  var t = {
    group: null,
    sort: !0,
    disabled: !1,
  ...
  _onTouchMove: function (e) {
    if (ie) {
      var t = this.options,
        ...
        s = g && a && a.d,
        u = Ne && I && pt(I),
        d = (r.clientX - ie.clientX + i.x) / (l || 1) + (u ? u[0] - qe[0] : 0) / (l || 1),
        c = (r.clientY - ie.clientY + i.y) / (s || 1) + (u ? u[1] - qe[1] : 0) / (s || 1);
      if (!p.active && !ue) {
