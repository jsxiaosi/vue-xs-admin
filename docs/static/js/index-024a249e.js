...
function W(n, e, t, o) {
  if (n) {
    ...
    do {
      if (
        (e != null && (e[0] === '>' ? n.parentNode === t && ze(n, e) : ze(n, e))) ||
        (o && n === t)
      )
        return n;
      if (n === t) break;
...
function ct(n, e) {
  for (
    ...
    t && (t === p.ghost || h(t, 'display') === 'none' || (e && !ze(t, e)));
...
function Y(n, e) {
  ...
  for (; (n = n.previousElementSibling); )
    n.nodeName.toUpperCase() !== 'TEMPLATE' && n !== p.clone && (!e || ze(n, e)) && t++;
  return t;
}
function Ct(n) {
  var e = 0,
...
function te(n, e) {
  if (!n || !n.getBoundingClientRect) return z();
  var t = n,
    o = !1;
  do
...
function hn(n) {
  ...
  if (((e = e || (t && t[X])), !!e)) {
    ...
    var x = j(j({}, v), Ne.getEventProperties(o, e));
...
p.prototype = {
    ...
    if (!g) {
      ...
      if (Ye) {
        ...
        I !== document.body && I !== document.documentElement
          ? (I === document && (I = z()), (t.top += I.scrollTop), (t.left += I.scrollLeft))
          : (I = z()),
          (tt = Ct(I));
      }
      (g = c.cloneNode(!0)),
  ...
  _onDragStart: function (e, t) {
    ...
    P('setupClone', this),
      ...
      !t && F(c, r.dragClass, !0),
      t
        ? ((je = !0), (o._loopId = setInterval(o._emulateDragOver, 50)))
...
p.mount = function () {
  ...
  e[0].constructor === Array && (e = e[0]),
    e.forEach(function (o) {
      ...
      o.utils && (p.utils = j(j({}, p.utils), o.utils)), Ne.mount(o);
    });
};
    ...
    (n.prototype = {
      ...
      _handleAutoScroll: function (t, o) {
        ...
        if (((Ve = t), o || this.options.forceAutoScrollFallback || Pe || K || Ce)) {
          ...
          if (!this.options.bubbleScroll || te(l, !0) === z()) {
            We();
            return;
          }
