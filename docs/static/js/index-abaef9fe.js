...
var vt = (n, e, t) =>
    e in n ? qt(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (n[e] = t),
  Ke = (n, e) => {
    for (var t in e || (e = {})) Qt.call(e, t) && vt(n, t, e[t]);
    if (mt) for (var t of mt(e)) Jt.call(e, t) && vt(n, t, e[t]);
    return n;
  },
  bt = (n, e) => Kt(n, Zt(e));
import {
...
import { _ as on } from './plugin-vueexport-helper-c27b6911.js';
/**!
 * Sortable 1.15.0
...
function z(n) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? Dt(Object(t), !0).forEach(function (o) {
          rn(n, o, t[o]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t))
      : Dt(Object(t)).forEach(function (o) {
...
var K = V(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  ...
  kt = V(/chrome/i) && V(/android/i),
  Xt = { capture: !1, passive: !1 };
function _(n, e, t) {
  n.addEventListener(e, t, !K && Xt);
}
function b(n, e, t) {
  n.removeEventListener(e, t, !K && Xt);
}
function je(n, e) {
  if (e) {
...
function F(n, e, t) {
  if (n && e)
    if (n.classList) n.classList[t ? 'add' : 'remove'](e);
      ...
      var o = (' ' + n.className + ' ').replace(Tt, ' ').replace(' ' + e + ' ', ' ');
      n.className = (o + (t ? ' ' + e : '')).replace(Tt, ' ');
    }
}
function h(n, e, t) {
  var o = n && n.style;
...
var c,
  ...
  Ye = Ft,
  At = Pe || K ? 'cssFloat' : 'float',
  bn = qe && !kt && !Ft && 'draggable' in document.createElement('div'),
  Lt = (function () {
    if (qe) {
      if (K) return !1;
...
p.prototype = {
      ...
      if (
        ...
        (s = function () {
          ...
          i._disableDelayedDragEvents(),
            !St && i.nativeDraggable && (c.draggable = !0),
        ...
        St && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (c.draggable = !0)),
  ...
  _disableDelayedDrag: function () {
    c && ot(c), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents();
  },
  ...
  _dragStarted: function (e, t) {
    if (((de = !1), w && c)) {
      P('dragStarted', this, { evt: t }), this.nativeDraggable && _(document, 'dragover', yn);
      var o = this.options;
      !e && F(c, o.dragClass, !1),
        F(c, o.ghostClass, !0),
        (p.active = this),
  ...
  _onTouchMove: function (e) {
    if (ae) {
      var t = this.options,
        ...
        s = g && a && a.d,
        u = Ye && I && Ot(I),
        f = (r.clientX - ae.clientX + i.x) / (l || 1) + (u ? u[0] - nt[0] : 0) / (l || 1),
        d = (r.clientY - ae.clientY + i.y) / (s || 1) + (u ? u[1] - nt[1] : 0) / (s || 1);
      if (!p.active && !de) {
    ...
    if (!g) {
      ...
      (g = c.cloneNode(!0)),
        ...
        h(
          g,
          'transform-origin',
          (It / parseInt(g.style.width)) * 100 + '% ' + (xt / parseInt(g.style.height)) * 100 + '%',
        );
    }
  },
  ...
  _onDragOver: function (e) {
        ...
        z(
          {
            ...
            target: o,
            completed: x,
            onMove: function (gt, Vt) {
              return Re(w, t, c, i, gt, C(gt), e, Vt);
            },
            changed: B,
          },
          $t,
    ...
    if (
      ...
      var N = dt(t, l.draggable);
      if (!N || (Tn(e, y, this) && !N.animated)) {
        if (N === c) return x(!1);
        ...
        var G = 0,
          oe,
          ge = c.parentNode !== t,
          M = !_n((c.animated && c.toRect) || i, (o.animated && o.toRect) || r, y),
          me = y ? 'top' : 'left',
          Z = Ct(o, 'top', 'top') || Ct(c, 'top', 'top'),
  ...
  toArray: function () {
    for (var e = [], t, o = this.el.children, i = 0, r = o.length, a = this.options; i < r; i++)
      (t = o[i]), W(t, a.draggable, this.el, !1) && e.push(t.getAttribute(a.dataIdAttr) || In(t));
    return e;
  },
  sort: function (e, t) {
    var o = {},
  ...
  option: function (e, t) {
    ...
    typeof i != 'undefined' ? (o[e] = i) : (o[e] = t), e === 'group' && Wt(o);
  },
  destroy: function () {
    P('destroy', this);
    var e = this.el;
...
function Tn(n, e, t) {
  var o = C(dt(t.el, t.options.draggable)),
    i = 10;
  return e
    ? n.clientX > o.right + i ||
...
function Cn(n, e, t, o, i, r, a, l) {
  ...
  if (!a) {
    ...
    } else if (s > f + (u * (1 - i)) / 2 && s < d - (u * (1 - i)) / 2) return On(e);
  }
  return (
...
function An() {
  ...
  return (
    (n.prototype = {
      ...
      nulling: function () {
        (Ve = ut = Se = ct = Te = it = rt = null), (T.length = 0);
      },
...
var at = Rt(function (n, e, t, o) {
    if (e.scroll) {
      var i = (n.touches ? n.touches[0] : n).clientX,
        ...
        f;
      ut !== t &&
        ((ut = t), We(), (Se = e.scroll), (f = e.scrollFn), Se === !0 && (Se = te(t, !0)));
      var d = 0,
        m = Se;
      do {
        var y = m,
...
function Nt(n, e) {
  en(() => {
    ...
    p.create(_t(n), Ke({ group: 'name', animation: 500, delay: 400, delayOnTouchOnly: !0 }, e));
  });
}
const pt = (n) => (tn('data-v-d38fb1a6'), (n = n()), nn(), n),
  Pn = pt(() => L('div', { class: 'card-header' }, [L('span', null, '列表拖拽')], -1)),
  Nn = { class: 'card-content' },
  Mn = pt(() => L('span', { class: 'handle' }, '::', -1)),
  Fn = pt(() => L('div', { class: 'card-header' }, [L('span', null, '宫格拖拽')], -1)),
  kn = { class: 'card-content' },
  Xn = Mt({ name: 'RtDrag' }),
  Yn = Mt(
    bt(Ke({}, Xn), {
      setup(n) {
...
const Gn = on(Yn, [['__scopeId', 'data-v-d38fb1a6']]);
