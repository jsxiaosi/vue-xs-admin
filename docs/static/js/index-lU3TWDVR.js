...
var P = (t, n, l) =>
    n in t ? U(t, n, { enumerable: !0, configurable: !0, writable: !0, value: l }) : (t[n] = l),
  k = (t, n) => {
    for (var l in n || (n = {})) q.call(n, l) && P(t, l, n[l]);
    if (F) for (var l of F(n)) z.call(n, l) && P(t, l, n[l]);
    return t;
  };
var T = (t, n, l) =>
  new Promise((i, c) => {
...
import { g as ee } from './slotsHelper-203bQ7mL.js';
...
function R(t) {
  return (
    typeof t == 'function' || (Object.prototype.toString.call(t) === '[object Object]' && !A(t))
  );
}
const ae = O({
    props: {
    ...
    setup(t, { slots: n }) {
      const { formItem: l, formModel: i } = t;
      function c() {
        const o = v(l.component),
          e = oe[l.component];
        if (e) {
          let a;
          return u(
            o,
            x({ modelValue: i[l.prop], 'onUpdate:modelValue': (r) => (i[l.prop] = r) }, l.props),
            R((a = s(e))) ? a : { default: () => [a] },
          );
        } else
          return u(
            o,
            x({ modelValue: i[l.prop], 'onUpdate:modelValue': (a) => (i[l.prop] = a) }, l.props),
            null,
          );
      }
      function s(o) {
        if (l.childrenComponent) {
          ...
          return u(I, null, [
            e == null
              ? void 0
              : e.map((r) => u(a, x({ label: r.label, value: r.value }, l.props), null)),
          ]);
        } else return;
      }
      return () => {
        let o;
        const { formItem: e } = t,
          { prop: a, render: r, rules: p, label: m } = e,
          g = { formModel: i, formItem: e },
          h = ee(n, a, g),
          _ = () => h || (r ? r(g) : c());
        return u(
          v('el-form-item'),
          { label: m, prop: a, rules: p },
          R((o = _())) ? o : { default: () => [o] },
        );
      };
    },
                  ...
                  default: d(() => [
                                        ...
                                        },
                                        {
                                          default: d(() => [
                                            u(
                                              ...
                                              W({ _: 2 }, [
                                                E(Object.keys(p.$slots), (S) => ({
                                                  name: S,
                                                  fn: d((G) => [Q(p.$slots, S, K(J(G || {})))]),
                                                })),
                                              ]),
                                              1032,
                    ...
                    u(w, null, {
                      default: d(() => [
                        u(
                          _,
                          { type: 'primary', onClick: m[0] || (m[0] = (b) => a()) },
                          { default: d(() => [y('Create')]), _: 1 },
                        ),
                        u(
                          _,
                          { onClick: m[1] || (m[1] = (b) => r()) },
                          { default: d(() => [y('Reset')]), _: 1 },
                        ),
                      ]),
                      _: 1,
                    }),
        ...
        return (
          ...
          C('div', ne, [
            X('div', re, [
              u(
                a,
                { onClick: e[0] || (e[0] = (r) => c('vertical')) },
                { default: d(() => [y('垂直')]), _: 1 },
              ),
              u(
                a,
                { onClick: e[1] || (e[1] = (r) => c('horizontal')) },
                { default: d(() => [y('水平')]), _: 1 },
              ),
            ]),
            u(
              te,
              { ref: 'formRef', 'form-option': i, onSubmitForm: s },
              {
                slotInput: d(({ formModel: r, formItem: p }) => [
                  u(
                    Y(N),
                    {
                      modelValue: r[p.prop],
                      'onUpdate:modelValue': (m) => (r[p.prop] = m),
                      type: p.inputType,
                      placeholder: '自定义输入框',
                    },
                    null,
  ...
  me = le(ue, [['__scopeId', 'data-v-167dce66']]);
