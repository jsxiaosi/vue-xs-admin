...
var Wt = (F, C, r) =>
    C in F ? ue(F, C, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (F[C] = r),
  tt = (F, C) => {
    for (var r in C || (C = {})) ce.call(C, r) && Wt(F, r, C[r]);
    if (Jt) for (var r of Jt(C)) ve.call(C, r) && Wt(F, r, C[r]);
    return F;
  },
  ct = (F, C) => fe(F, de(C));
import {
...
function kt(F, C, r) {
  const { obj: e, k: t } = Gt(F, C, Object);
  e[t] = r;
}
function Re(F, C, r, e) {
  const { obj: t, k: n } = Gt(F, C, Object);
  (t[n] = t[n] || []), e && (t[n] = t[n].concat(r)), e || t[n].push(r);
}
function Ut(F, C) {
  const { obj: r, k: e } = Gt(F, C);
  if (r) return r[e];
}
function Pe(F, C, r) {
  const e = Ut(F, r);
...
var Ie = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;', '/': '&#x2F;' };
function Me(F) {
  return typeof F == 'string' ? F.replace(/[&<>"'\/]/g, (C) => Ie[C]) : F;
}
const Ne = [' ', ',', '?', '!', ';'];
function Le(F, C, r) {
  (C = C || ''), (r = r || '');
...
function be() {
  ...
  return (
    Oe.forEach((C) => {
      C.lngs.forEach((r) => {
        F[r] = { numbers: C.nr, plurals: Fe[C.fc] };
      });
    }),
    F
  );
      ...
      return (
        ...
        (o, a) => (
          ...
          ye('div', ze, [
            ...
            Xt('div', { class: 'innerHTML', innerHTML: e.value }, null, 8, Ke),
          ])
        )
      );
    },
  });
const Ze = Ee(Ge, [['__scopeId', 'data-v-ae07b129']]);
