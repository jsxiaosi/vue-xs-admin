import { t as j } from './index-03c2fa83.js';
import {
  d as re,
  j as S,
  B as r,
    ...
    setup(a, { expose: d, emit: s }) {
      ...
      function Se(i) {
        ...
        const o = i.targetTouches[0],
          { direction: u } = e(n);
        let w = { x: o.pageX - B.x, y: o.pageY - B.y };
        i.preventDefault();
      ...
      function ne() {
        $e(() => {
          ...
          if (((P.value = ''), e(E))) {
            ...
            e(z) && (o = o * 2 + 1), (e(J).style.width = o + 'px'), (M.value = o);
          }
          if (e(z)) (q = 'ease-in'), (p.value = 0);
          else {
            (q = 'linear'), (p.value = i);
            return;
          }
                    ...
                    default: A(() => [
                      v('ul', Xe, [
                        ...
                        H(
                          De,
                          null,
                          Pe(e(s), (m, y) => ($(), H('li', { key: y }, Be(m.title), 1))),
                          128,
                        )),
                      ]),
                    ]),
...
const Ze = Ee(Ke, [['__scopeId', 'data-v-b6e12e9c']]);
