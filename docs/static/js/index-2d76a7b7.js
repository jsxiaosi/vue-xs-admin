...
function de(e, r, t, o = {}) {
  ...
  return c && g && (T(c, 'storage', _), T(c, z, P)), _(), p;
  function u(n) {
    try {
      if (n == null) t.removeItem(e);
        ...
        f !== s &&
          ...
          c &&
            c.dispatchEvent(
              new CustomEvent(z, { detail: { key: e, oldValue: f, newValue: s, storageArea: t } }),
            ));
      }
    } catch (s) {
      y(s);
...
function _e(e = {}) {
  const {
    ...
    A = B('updateHTMLAttrs', (u, b, P) => {
      const _ = typeof u == 'string' ? (a == null ? void 0 : a.document.querySelector(u)) : H(u);
      if (!_) return;
      let n;
      if (d) {
