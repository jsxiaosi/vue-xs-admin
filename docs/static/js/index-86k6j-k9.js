...
import {
  ...
  u as Ic,
  e5 as Pc,
} from './useECharts-eiv5iSAH.js';
import { _ as Ec } from './plugin-vueexport-helper-x3n3nnut.js';
var kc = (function (a) {
  R(e, a);
  function e() {
    ...
    setup(a) {
      ...
      lh(() =>
        Ii(this, null, function* () {
          const s = (yield uh(() => import('./china-0UDMtOrD.js'), __vite__mapDeps([]))).default;
          Pc('china', s),
            t(r),
            hh(
              () => {
      ...
      return (s, l) => (
        vh(),
        ch('div', Zx, [fh('div', { ref_key: 'chartRef', ref: e, class: 'chart-ref' }, null, 512)])
      );
    },
  }),
  jx = Ec(Ux, [['__scopeId', 'data-v-64c62161']]);
