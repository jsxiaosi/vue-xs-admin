...
import { S as de } from './index-31bde1fa.js';
import { u as ie, _ as yn, A as vn, a as mn, b as hn } from './index-db9d571b.js';
import { _ as ye } from './plugin-vueexport-helper-c27b6911.js';
import { u as gn, a as Wt } from './index-fbdc8db2.js';
...
var ut = function () {
  ...
  q =
    ...
    (Rn
      ...
      : null),
  Ee = {},
  Dn = typeof Uint8Array == 'undefined' || !q ? $ : q(Uint8Array),
  $e = {
...
var Hn = gr.exports,
  ...
  Re = Kn ? WeakMap.prototype.has : null,
      ...
      var U = Ge(e, f),
        ...
        I =
          X || typeof e.constructor != 'function'
            ...
            ? e.constructor.name + ' '
            : '',
        T = I + (re || te ? '[' + ue.call(Yt.call([], re || [], te || []), ': ') + '] ' : '');
      return U.length === 0
        ? T + '{}'
        : y
        ? T + '{' + wt(U, y) + '}'
                              ...
                              label: O(() => [
                                A(
                                  'div',
                                  {
                                    ...
                                    onClick: (T) => w(I),
                                    onContextmenu: pr((T) => le(I, T), ['prevent']),
                                  },
                                  null,
                                  40,
                                  _a,
...
const $a = ye(Aa, [['__scopeId', 'data-v-f9f202d2']]),
  Nr = () => {
...
(function (t) {
  ...
  function y(c, d, v, F, J) {
    for (var R = [], x = 0, D = d.length; x < D; ++x)
      fe(d, String(x)) ? R.push(f(c, d, v, F, String(x), !0)) : R.push('');
    return (
      J.forEach(function (j) {
        j.match(/^\d+$/) || R.push(f(c, d, v, F, j, !0));
      }),
      R
    );
  }
  function f(c, d, v, F, J, R) {
    var x, D, j;
    if (
...
`))))
  ...
  function m(c, d, v) {
    var F = c.reduce(function (J, R) {
      return (
        R.indexOf(`
`) >= 0,
        J + R.replace(/\u001b\[\d\d?m/g, '').length + 1
      );
    }, 0);
    return F > 60
      ? v[0] +
 ...
 `) +
  ...
  t.isObject = U;
  function X(c) {
    return U(c) && T(c) === '[object Date]';
  }
  t.isDate = X;
  function te(c) {
    return U(c) && (T(c) === '[object Error]' || c instanceof Error);
  }
  t.isError = te;
  function re(c) {
...
const Pt = ye(ka, [['__scopeId', 'data-v-fd4f95f6']]),
  ...
  Ur = (t) => (Et('data-v-be125950'), (t = t()), Ct(), t),
  Da = { class: 'color-list' },
  Va = ['onClick'],
  Ba = { class: 'options' },
  Ua = { class: 'options' },
...
const Ga = ye(ja, [['__scopeId', 'data-v-be125950']]),
  qa = { class: 'options' },
  Ha = { class: 'options' },
  Qa = { class: 'options' },
  Ja = { class: 'options' },
...
const Xa = ye(Ya, [['__scopeId', 'data-v-eb802925']]),
                ...
                default: O(() => [
                  A('div', ti, [
                    S(
                      ...
                      { default: O(() => [Te(H(i.$t('layout.layoutSettings')), 1)]), _: 1 },
                    ),
                    A('div', ri, [
                      A('div', ni, [
                        (_(),
                    ...
                    S(
                      y,
                      { 'content-position': 'center' },
                      { default: O(() => [Te(H(i.$t('layout.themeSettings')), 1)]), _: 1 },
                    ),
                    A('div', null, [S(Ga)]),
                    S(
                      y,
                      { 'content-position': 'center' },
                      { default: O(() => [Te(H(i.$t('layout.pageSettings')), 1)]), _: 1 },
                    ),
                    A('div', null, [S(Xa)]),
                    S(
                      m,
                      { class: 'clear_storage', type: 'danger', onClick: s },
                      { default: O(() => [Te(H(i.$t('layout.clearStorage')), 1)]), _: 1 },
                    ),
                  ]),
                ]),
                _: 1,
                        ...
                        E(
                          ...
                          [
                            ...
                            g(r).sidebarMode === 'blend'
                              ? (_(),
                                V(Ra, { key: 1, class: 'sidebar-horizontal', mode: 'horizontal' }))
                              : ee('', !0),
                          ],
                          64,
                        )),
