import { t as j } from './index-5497d948.js';
import {
  d as re,
  j as S,
  A as r,
...
import { _ as Be } from './plugin-vueexport-helper-c27b6911.js';
const f = window,
  Ee = () => {
...
const Ie = Object.freeze(
    Object.defineProperty(
      { __proto__: null, animationFrame: Ee, arrayEqual: Le, copyObj: ue },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  Ne = re({
    ...
    setup(a, { expose: d, emit: s }) {
      ...
      const J = j(`wrap${y.key}`, null),
        K = j(`slotList${y.key}`, null),
        G = j(`realBox${y.key}`, null);
      let Q = r(() => e(t) < 0),
        Z = r(() => Math.abs(e(t)) < e(M) - e(g)),
        ce = r(() => ({
          step: 1,
          limitMoveNum: 5,
          hoverStop: !0,
      ...
      let de = r(() => (e(Z) ? '' : e(n).switchDisabledClass)),
        ...
        me = r(() => ({
          position: 'absolute',
          margin: `${e(m) / 2}px 0 0 ${e(g) + e(n).switchOffset}px`,
          transform: 'translateY(-50%)',
        })),
        B = r(() => e(n).direction !== 'bottom' && e(n).direction !== 'top'),
        ee = r(() => (e(B) ? { float: 'left', overflow: 'hidden' } : { overflow: 'hidden' })),
        he = r(() => ({
        ...
        E = r(() => e(n).navigation),
        L = r(() => (e(E) ? !1 : e(n).autoPlay)),
        te = r(() => c.data.length >= e(n).limitMoveNum),
        le = r(() => e(n).hoverStop && e(L) && e(te)),
        I = r(() => e(n).openTouch),
        ie = r(() =>
          e(n).isSingleRemUnit
      ...
      function ye() {
        if (e(Z)) {
          if (e(M) - e(g) + e(t) < e(n).switchSingleStep) {
            t.value = e(g) - e(M);
            return;
          }
          t.value -= e(n).switchSingleStep;
      ...
      function ne() {
        $e(() => {
          ...
          if (((P.value = ''), e(B))) {
            (m.value = e(J).offsetHeight), (g.value = e(J).offsetWidth);
            let o = e(K).offsetWidth;
            e(L) && (o = o * 2 + 1), (e(G).style.width = o + 'px'), (M.value = o);
          }
            ...
            [
              e(E)
                ? ($(),
                  H(
                    'div',
                    { key: 0, style: b(e(pe)), class: oe(fe.value), onClick: ge },
              ...
              e(E)
                ? ($(),
                  H(
                    'div',
                    { key: 1, style: b(e(me)), class: oe(e(de)), onClick: ye },
              ...
              v(
                ...
                [
                  v(
                    'div',
                    { ref: 'slotList' + e(y).key, style: b(e(ee)) },
                    [Y(i.$slots, 'default')],
                    4,
                  ),
  ...
  Ye = (a) => (qe('data-v-b6e12e9c'), (a = a()), ze(), a),
                    ...
                    default: A(() => [
                      v('ul', Xe, [
                        ...
                        H(
                          De,
                          null,
                          Pe(e(s), (m, g) => ($(), H('li', { key: g }, We(m.title), 1))),
                          128,
                        )),
                      ]),
                    ]),
...
const Ze = Be(Je, [['__scopeId', 'data-v-b6e12e9c']]);
