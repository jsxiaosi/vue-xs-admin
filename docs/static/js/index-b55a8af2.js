...
var Wt = (O, C, r) =>
    C in O ? ue(O, C, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (O[C] = r),
  tt = (O, C) => {
    for (var r in C || (C = {})) ce.call(C, r) && Wt(O, r, C[r]);
    if (Jt) for (var r of Jt(C)) ve.call(C, r) && Wt(O, r, C[r]);
    return O;
  },
  ct = (O, C) => fe(O, de(C));
import {
  ...
  (function (e, t) {
	...
	***************************************************************************** */ var n = function (
        ...
        function o(M, L) {
          ...
          M.prototype = L === null ? Object.create(L) : ((B.prototype = L.prototype), new B());
        }
        var a = function () {
          return (
            (a =
              ...
              function (L) {
                for (var B, F = 1, w = arguments.length; F < w; F++) {
                  B = arguments[F];
                  for (var H in B) Object.prototype.hasOwnProperty.call(B, H) && (L[H] = B[H]);
                }
                return L;
              }),
        ...
        function i(M, L) {
          var B = {};
          for (var F in M)
            Object.prototype.hasOwnProperty.call(M, F) && L.indexOf(F) < 0 && (B[F] = M[F]);
          if (M != null && typeof Object.getOwnPropertySymbols == 'function')
            for (var w = 0, F = Object.getOwnPropertySymbols(M); w < F.length; w++)
              L.indexOf(F[w]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(M, F[w]) &&
                (B[F[w]] = M[F[w]]);
          return B;
        }
        function s(M, L, B, F) {
          var w = arguments.length,
            H = w < 3 ? L : F === null ? (F = Object.getOwnPropertyDescriptor(L, B)) : F,
            b;
          if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
            H = Reflect.decorate(M, L, B, F);
          else
            for (var U = M.length - 1; U >= 0; U--)
              (b = M[U]) && (H = (w < 3 ? b(H) : w > 3 ? b(L, B, H) : b(L, B)) || H);
          return w > 3 && H && Object.defineProperty(L, B, H), H;
        }
        function h(M, L) {
          return function (B, F) {
            L(B, F, M);
        ...
        function d(M, L, B, F) {
          ...
          return new (B || (B = Promise))(function (H, b) {
            function U(W) {
              try {
                j(F.next(W));
              } catch (G) {
        ...
        var l = Object.create
          ...
          : function (M, L, B, F) {
              F === void 0 && (F = B), (M[F] = L[B]);
            };
        function c(M, L) {
          for (var B in M)
            B !== 'default' && !Object.prototype.hasOwnProperty.call(L, B) && l(L, M, B);
        }
        function f(M) {
        ...
        function g(M, L) {
          ...
          var F = B.call(M),
            ...
            b;
          try {
            for (; (L === void 0 || L-- > 0) && !(w = F.next()).done; ) H.push(w.value);
          } catch (U) {
            b = { error: U };
          } finally {
            try {
        ...
        function m() {
          for (var M = 0, L = 0, B = arguments.length; L < B; L++) M += arguments[L].length;
          for (var F = Array(M), w = 0, L = 0; L < B; L++)
            for (var H = arguments[L], b = 0, U = H.length; b < U; b++, w++) F[w] = H[b];
          return F;
        }
        function A(M, L) {
          for (var B = 0, F = L.length, w = M.length; B < F; B++, w++) M[w] = L[B];
          return M;
        }
        function y(M) {
        ...
        function S(M) {
          ...
          function F(w, H) {
            L[w] = M[w]
              ? function (b) {
                  return (B = !B) ? { value: y(M[w](b)), done: w === 'return' } : H ? H(b) : b;
                }
              : H;
          }
        }
        ...
        function x(M) {
          ...
          if (M != null)
            for (var B in M)
              B !== 'default' && Object.prototype.hasOwnProperty.call(M, B) && l(L, M, B);
          return D(L, M), L;
        }
        function T(M) {
...
/mg`,
              ...
              var L = T.length;
              if (!L) return this;
              for (var B = 0; B < L; B++) this.elems.push(T[B]);
              this.length = L;
            }
          }
          return (
                  ...
                  (0, i.default)((N = this)).call(N, function (M) {
                    if (T) {
                      for (var L = -1, B = 0; B < m.length; B++) {
                        var F = m[B];
                        if (F.selector === T && F.fn === I && F.elem === M) {
                          L = B;
                          break;
                        }
                      }
            ...
            (D.prototype.css = function (x, T) {
              ...
              return (
                ...
                (0, i.default)((I = this)).call(I, function (M) {
                  var L,
                    B = (0, h.default)((L = M.getAttribute('style') || '')).call(L);
                  if (B) {
                    var F = S(B);
                    (F = (0, s.default)(F).call(F, function (w) {
                      return (0, d.default)(w).call(w, x) === 0 ? N : w;
                    })),
                      N != '' && (0, d.default)(F).call(F, N) < 0 && F.push(N),
                      N == '' && (F = S(F)),
                      M.setAttribute('style', F.join('; '));
            ...
            (D.prototype.insertAfter = function (x) {
              ...
              return N
                ? (0, i.default)((T = this)).call(T, function (L) {
                    var B = N.parentNode;
                    M ? B.insertBefore(L, M) : B.appendChild(L);
                  })
                : this;
            }),
      ...
      function (r, e, t) {
        ...
        function D(x) {
          ...
          var I = (0, d.default)(T).call(T, function (B) {
                  ...
                  (0, a.default)(I).call(I, function (B, F) {
                    if (B) {
                      ...
                      x.append(U),
                        N.push(b),
                        M.push(U),
                        F === 0 ? (b.data('active', !0), b.addClass('w-e-active')) : U.hide(),
                        b.on('click', function () {
                          b.data('active') ||
        ...
        r.exports = function (S, R, P, D, x, T, I) {
          ...
          if (
            ...
            if (((U = { values: N(A), keys: T ? w : N(m), entries: N(y) }), I))
              for (K in U) (g || L || !(K in B)) && u(B, K, U[K]);
...
`),
                    ...
                    if (F && typeof F == 'function') {
                      var b;
                      F(w, (0, a.default)((b = this.insertImg)).call(b, this));
                      return;
                    }
                    var U = new FormData();
                    if (
          ...
          if (
            ...
            c(
              ...
              function (M) {
                ...
                M in x &&
                  !(R && M == 'clear') &&
                  s(I.prototype, M, function (B, F) {
                    var w = N(this).collection;
                    if (!L && R && !d(B)) return M == 'get' ? void 0 : !1;
                    var H = w[M](B === 0 ? 0 : B, F);
                    return L ? this : H;
                  });
              },
...
`,
      ...
      function (r, e, t) {
        var n = t(5),
          ...
          At = function (X, Q, q, et) {
            Q.done || ((Q.done = !0), et && (Q = et), (Q.value = q), (Q.state = Ft), yt(X, Q, !0));
          },
      ...
      function (r, e, t) {
        ...
        ot[$][V] || I(ot[$], V, ot[$].valueOf), U(ot, G), (B[W] = !0);
      },
      function (r, e, t) {
        var n = t(30),
          o = t(126).f,
          ...
          function m(A) {
            ...
            if (x) {
              ...
              if (u.urlRegex.test(D) && E) {
                ...
                if (((B.innerHTML = M), L == null)) return;
            ...
            return (
              ...
              (y.prototype.init = function () {
                var E,
                  ...
                  D = P.excludeMenus;
                (0, a.default)(D) === !1 && (D = []),
                  (P.menus = (0, i.default)((E = P.menus)).call(E, function (F) {
                    return (0, s.default)(D).call(D, F) === !1;
                  }));
                var x = (0, h.default)(g.default.globalCustomMenuConstructorList);
                (x = (0, i.default)(x).call(x, function (F) {
                  return (0, s.default)(D).call(D, F);
                })),
                  (0, u.default)(x).call(x, function (F) {
                    delete g.default.globalCustomMenuConstructorList[F];
                  }),
                  (0, u.default)((S = P.menus)).call(S, function (F) {
                    var w = R.constructorList[F];
                    R._initMenuList(F, w);
                  });
                for (
              ...
              <div></div>
                ...
                S.on('mouseover', function (N) {
                  ...
                  if (B && F) {
                    ...
                    D.text(E.i18next.t('menus.title.' + B));
          ...
          g = (function (p) {
            ...
            return (
              ...
              (m.prototype.setMultilineHead = function (A) {
                ...
                for (var B = 0; N[B].getNode() !== I.getNodeTop(R).getNode(); ) {
                  if (!N[B].elems[0]) return;
                  var F = l.default(N[B].next().getNode());
                  N.push(F), B++;
                }
                N == null ||
        ...
        function c(f, g, p) {
          ...
          function D(N, M) {
            var L = N.replace(/</g, '&lt;').replace(/>/g, '&gt;'),
              B = d.default('<a target="_blank">' + L + '</a>'),
              F = B.elems[0];
            (F.innerText = N), (F.href = M), v.default(f) && P(), f.cmd.do('insertElem', B);
          }
          function x() {
            if (v.default(f))
              if ((P(), R.getNodeName() === 'A')) {
                ...
                var B = v.getParentNodeA(R),
                  F = B.innerHTML;
                f.cmd.do('insertHTML', '<span>' + F + '</span>');
              }
          }
          function T(N, M) {
          ...
          var I = {
                ...
                events: [
                  {
                    ...
                    fn: function () {
                      ...
                      K &&
                        ...
                        (V =
                          (F = l.insertHtml(K, U)) === null || F === void 0
                            ? void 0
                      ...
                      if (G && ($ || ($ = G), !!T($, G))) {
                        ...
                        if (
                          ...
                          (0, a.default)((B = v.EXTRA_TAG)).call(B, b.nodeName)
                        ) {
            ...
            setLinkValue: function (M, L) {
              ...
              L === 'text' && ((B = '#' + A), (F = g)),
                L === 'link' && ((B = '#' + m), (F = p)),
                (w = (0, s.default)(M).call(M, B).elems[0]),
                (w.value = F);
            },
          };
          return I;
        ...
        function u(l, c) {
          ...
          for (
            y && (T = h(P, y, S != null ? S : 0)),
              ...
              y && (M = i(y, P)),
              E && (L = i(E, P)),
              B = (g = M == null ? void 0 : M.nextSibling) !== null && g !== void 0 ? g : y;
            ...
            if (w === '#text') I = I + (B == null ? void 0 : B.textContent);
              ...
              var H =
                (m =
                  (p = B == null ? void 0 : B.firstChild) === null || p === void 0
                    ? void 0
            ...
            var b = (A = B == null ? void 0 : B.nextSibling) !== null && A !== void 0 ? A : B;
            if (b === B) break;
            B = b;
          }
              ...
              (p.prototype.uploadVideo = function (m) {
                ...
                if (m.length) {
                  var y = this.editor,
                    ...
                    B = E.uploadVideoTimeout,
                    F = E.withVideoCredentials,
        ...
        <input
          ...
          return (
            window.FileReader &&
              ...
              B.tabs.push(L[0]),
            f.showLinkImg && (B.tabs.push(L[1]), (B.onlyUploadConf = void 0)),
            B
          );
        }
        e.default = v;
            ...
            return (
              (l.prototype.exec = function () {
                ...
                if (
                  ...
                  var D;
                  (0, a.default)((D = p == null ? void 0 : p.children())).call(D, function (B) {
                    E.push(s.default(B));
                  }),
                    S === f
                  ...
                  if (
                    ...
                    (0, a.default)(N).call(N, function (B) {
                      M.append(B.elems[0]);
                    }),
              ...
              (l.prototype.exec = function () {
                ...
                if (N === M)
                  if (I.length > 2)
                    ...
                    I.length = 0;
                    for (var F = u.getStartPoint(D); F.length; ) I.push(F), (F = F.next());
                  ...
                  for (var j = [], F = u.getStartPoint(D); F.length; ) j.push(F), (F = F.next());
                  if (
              ...
              P = [
                ...
                },
                {
                  ...
                  onClick: function (x, T) {
                    ...
                    var L = Number(E.getCurrentRowIndex(T.elems[0], M)),
                      B = E.getTableHtml(T.elems[0]),
                      F = E.getTableHtml(h.default.ProcessingRow(i.default(B), L).elems[0]);
                    return (
                      (F = f(T, F)),
                      x.selection.createRangeByElem(T),
                      x.selection.restoreSelection(),
                      x.cmd.do('insertHTML', F),
                      !0
                    );
                  },
                },
                {
                  ...
                  onClick: function (x, T) {
                    ...
                    var L = Number(E.getCurrentRowIndex(T.elems[0], M)),
                      B = E.getTableHtml(T.elems[0]),
                      F = h.default.DeleteRow(i.default(B), L).elems[0].children[0].children.length,
                      w = '';
                    return (
                      x.selection.createRangeByElem(T),
                      x.selection.restoreSelection(),
                      F === 0
                        ? (w = d.EMPTY_P)
                        : (w = E.getTableHtml(h.default.DeleteRow(i.default(B), L).elems[0])),
                      (w = f(T, w)),
                ...
                },
                {
                  ...
                  onClick: function (x, T) {
                    ...
                    var N = i.default(x.selection.getSelectionStartElem()),
                      ...
                      B = E.getTableHtml(h.default.ProcessingCol(i.default(L), M).elems[0]);
                    return (
                      (B = f(T, B)),
                      x.selection.createRangeByElem(T),
                      x.selection.restoreSelection(),
                ...
                },
                {
                  ...
                  onClick: function (x, T) {
                    ...
                    var N = i.default(x.selection.getSelectionStartElem()),
                      M = E.getCurrentColIndex(N.elems[0]),
                      L = E.getTableHtml(T.elems[0]),
                      B = h.default.DeleteCol(i.default(L), M),
                      F = B.elems[0].children[0].children[0].children.length,
                      w = '';
                    return (
                      x.selection.createRangeByElem(T),
                      x.selection.restoreSelection(),
                      F === 0 ? (w = d.EMPTY_P) : (w = E.getTableHtml(B.elems[0])),
                      (w = f(T, w)),
                      x.cmd.do('insertHTML', w),
                      !0
                    );
                ...
                },
                {
                  ...
                  onClick: function (x, T) {
                    ...
                    var L = Number(E.getCurrentRowIndex(T.elems[0], M));
                    L !== 0 && (L = 0);
                    var B = E.getTableHtml(T.elems[0]),
                      F = E.getTableHtml(h.default.setTheHeader(i.default(B), L, 'th').elems[0]);
                    return (
                      (F = f(T, F)),
                      x.selection.createRangeByElem(T),
                      x.selection.restoreSelection(),
                ...
                },
                {
                  ...
                  onClick: function (x, T) {
                    ...
                    var L = E.getTableHtml(T.elems[0]),
                      B = E.getTableHtml(h.default.setTheHeader(i.default(L), M, 'td').elems[0]);
                    return (
                      (B = f(T, B)),
                      x.selection.createRangeByElem(T),
                      x.selection.restoreSelection(),
            ...
            var S = m(A),
              ...
              x = function (N) {
                var M,
                  ...
                  B = P[N];
                (0, s.default)((M = (0, h.default)(B.childNodes))).call(M, function (F) {
                  L.appendChild(F);
                }),
                  D.appendChild(L);
              },
              ...
              if (!(x != null && x.collapsed)) {
                ...
                T == null ||
                  (0, a.default)(T).call(T, function (J, k) {
                    J.contains(I) && (B = k), J.contains(N) && (F = k);
                  }),
                  F - B > 1 &&
                    (T == null ||
                      (0, a.default)(T).call(T, function (J, k) {
          ...
          function g(A) {
            ...
            if (h.isAllTodo(c)) {
              ...
              if (
                ...
                A.preventDefault(),
                  P == null ||
                    (0, a.default)((L = P.childNodes)).call(L, function (B, F) {
                      F !== 0 && x.appendChild(B.cloneNode(!0));
                    }),
                  D.insertAfter(R),
                  R.remove();
              }
...
const Ce = pe(Se),
  De = {
    ...
    output(O, C) {
      console && console[O] && console[O].apply(console, C);
    },
  };
class wt {
  constructor(C) {
...
function Bt() {
  ...
  return (r.resolve = O), (r.reject = C), r;
}
function Zt(O) {
  return O == null ? '' : '' + O;
}
...
function Gt(O, C, r) {
  ...
  for (; n.length > 1; ) {
    ...
    const o = e(n.shift());
    !O[o] && r && (O[o] = new r()),
      Object.prototype.hasOwnProperty.call(O, o) ? (O = O[o]) : (O = {});
  }
  return t() ? {} : { obj: O, k: e(n.shift()) };
}
function kt(O, C, r) {
  const { obj: e, k: t } = Gt(O, C, Object);
  e[t] = r;
}
function Re(O, C, r, e) {
  const { obj: t, k: n } = Gt(O, C, Object);
  (t[n] = t[n] || []), e && (t[n] = t[n].concat(r)), e || t[n].push(r);
}
function Ut(O, C) {
  const { obj: r, k: e } = Gt(O, C);
  if (r) return r[e];
}
function Pe(O, C, r) {
  const e = Ut(O, r);
...
var Ie = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;', '/': '&#x2F;' };
function Me(O) {
  return typeof O == 'string' ? O.replace(/[&<>"'\/]/g, (C) => Ie[C]) : O;
}
const Ne = [' ', ',', '?', '!', ';'];
function Le(O, C, r) {
  (C = C || ''), (r = r || '');
  const e = Ne.filter((o) => C.indexOf(o) < 0 && r.indexOf(o) < 0);
  if (e.length === 0) return !0;
  const t = new RegExp(`(${e.map((o) => (o === '?' ? '\\?' : o)).join('|')})`);
  let n = !t.test(O);
  if (!n) {
    const o = O.indexOf(r);
    o > 0 && !t.test(O.substring(0, o)) && (n = !0);
  }
  return n;
}
function jt(O, C) {
    ...
    if (
      ...
      if (y || A || I) {
        if ((this.logger.log(I ? 'updateKey' : 'missingKey', s, i, o, I ? D : d), n)) {
          const B = this.resolve(o, ct(tt({}, r), { keySeparator: !1 }));
          B &&
            B.res &&
            this.logger.warn(
        ...
        const L = (B, F, w) => {
          ...
          this.options.missingKeyHandler
            ? this.options.missingKeyHandler(B, i, F, H, I, r)
            : this.backendConnector &&
              this.backendConnector.saveMissing &&
              this.backendConnector.saveMissing(B, i, F, H, I, r),
            this.emit('missingKey', B, i, F, d);
        };
        this.options.saveMissing &&
          (this.options.saveMissingPlurals && E
            ? N.forEach((B) => {
                this.pluralResolver.getSuffixes(B, r).forEach((F) => {
                  L([B], o + F, r[`defaultValue${F}`] || D);
                });
              })
            : L(N, o, D));
      }
    ...
    if (typeof C == 'string' && C.indexOf('-') > -1) {
      ...
      return (
        this.options.lowerCaseLng
          ...
          ? ((e[0] = e[0].toLowerCase()),
            (e[1] = e[1].toUpperCase()),
            r.indexOf(e[1].toLowerCase()) > -1 && (e[1] = Kt(e[1].toLowerCase())))
          : e.length === 3 &&
            ((e[0] = e[0].toLowerCase()),
            e[1].length === 2 && (e[1] = e[1].toUpperCase()),
            e[0] !== 'sgn' && e[2].length === 2 && (e[2] = e[2].toUpperCase()),
            r.indexOf(e[1].toLowerCase()) > -1 && (e[1] = Kt(e[1].toLowerCase())),
            r.indexOf(e[2].toLowerCase()) > -1 && (e[2] = Kt(e[2].toLowerCase()))),
        e.join('-')
      );
    }
...
function be() {
  ...
  return (
    Be.forEach((C) => {
      C.lngs.forEach((r) => {
        O[r] = { numbers: C.nr, plurals: Oe[C.fc] };
      });
    }),
    O
  );
...
class we {
  constructor(C) {
    ...
    (this.languageUtils = C),
      ...
      (!this.options.compatibilityJSON || He.includes(this.options.compatibilityJSON)) &&
  ...
  getSuffixes(C) {
    ...
    return e
      ? this.shouldUseIntlApi()
        ? e
            .resolvedOptions()
            .pluralCategories.sort((t, n) => ee[t] - ee[n])
            .map(
              (t) =>
...
function ne(O, C, r) {
  let e = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : '.',
    ...
    n = Pe(O, C, r);
  return (
    !n && t && typeof r == 'string' && ((n = jt(O, r, e)), n === void 0 && (n = jt(C, r, e))), n
  );
}
class Ue {
  constructor() {
  ...
  init() {
    ...
    (this.escape = r.escape !== void 0 ? r.escape : Me),
  ...
  interpolate(C, r, e, t) {
    ...
    const h = (l) => {
      if (l.indexOf(this.formatSeparator) < 0) {
        const p = ne(r, i, l, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(
        ne(r, i, f, this.options.keySeparator, this.options.ignoreJSONStructure),
        g,
        e,
    ...
    return (
      [
        ...
        for (a = 0; (n = l.regex.exec(C)); ) {
          ...
          else typeof o != 'string' && !this.useRawValueToEscape && (o = Zt(o));
...
class $e {
  ...
  format(C, r, e) {
    ...
    return r.split(this.formatSeparator).reduce((a, i) => {
      const { formatName: s, formatOptions: h } = je(i);
      if (this.formats[s]) {
        let u = a;
        try {
...
function Qe(O, C) {
  O.pending[C] !== void 0 && (delete O.pending[C], O.pendingCount--);
}
class Ve extends Vt {
  constructor(C, r, e) {
    let t = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
...
class Ot extends Vt {
  ...
  init() {
    ...
    const t = re();
    (this.options = tt(tt(tt({}, t), this.options), oe(r))),
      this.options.compatibilityAPI !== 'v1' &&
    ...
    if (!this.options.isClone) {
      ...
      (d.logger = pt),
        ...
        (d.interpolator = new Ue(this.options)),
        (d.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }),
        (d.backendConnector = new Ve(n(this.modules.backend), d.resourceStore, d, this.options)),
  ...
  use(C) {
    ...
    return (
      ...
      C.type === 'postProcessor' && le.addPostProcessor(C),
  ...
  dir(C) {
    ...
    const r = [
      ...
      e = (this.services && this.services.languageUtils) || new te(re());
  ...
  cloneInstance() {
    ...
    return (
      ...
      e && ((n.store = new qt(this.store.data, t)), (n.services.resourceStore = n.store)),
...
const it = Ot.createInstance();
it.createInstance = Ot.createInstance;
it.createInstance;
it.dir;
it.init;
it.loadResources;
...
it.loadNamespaces;
it.loadLanguages;
const ze = 'var(--main-bg-color)',
  Ke = { mainBgColor: ze },
  Ge = { class: 'page-container' },
  Je = ['innerHTML'],
  We = he({
    __name: 'index',
    setup(O) {
      console.log(Ke.mainBgColor);
      const C = zt({}),
        r = zt({}),
        e = zt(''),
        { locale: t } = ge();
      function n() {
        (r.value = new Ce(xe(C))),
          console.log(r.value.config),
          (r.value.config.lang = t.value === 'zh-ch' ? 'zh-ch' : 'en'),
      ...
      return (
        ...
        (o, a) => (
          Ae(),
          ye('div', Ge, [
            Xt('div', { ref_key: 'editorELRef', ref: C }, null, 512),
            Xt('div', { class: 'innerHTML', innerHTML: e.value }, null, 8, Je),
          ])
        )
      );
    },
  });
const qe = Ee(We, [['__scopeId', 'data-v-c6bd8a30']]);
