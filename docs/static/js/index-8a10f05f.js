...
var Lt = (t, e, r) =>
  new Promise((n, a) => {
    var o = (i) => {
      ...
      u = (i) => (i.done ? n(i.value) : Promise.resolve(i.value).then(o, l));
...
import { S as ye } from './index-3192f30e.js';
import { u as ie, _ as cn, A as fn, a as pn, b as dn } from './index-d5ab720f.js';
import { u as yn } from './useSortable-04358ef3.js';
import { _ as me } from './plugin-vueexport-helper-c27b6911.js';
import { u as vn, a as Wt } from './index-2d3590d4.js';
              ...
              default: O(({ Component: o, route: l }) => [
                S(
                  ...
                  { name: 'fade-transform', mode: 'out-in' },
                  {
                    default: O(() => [
                      (_(),
                      V(Jr, { include: e.value }, [(_(), V(cr(o), { key: l.fullPath }))], 1032, [
                        'include',
                      ])),
                    ]),
                    _: 2,
...
var Rn = function t(e) {
  ...
  Ln = function (e) {
    ...
    var a = [];
    return (
      Ht(e, Un, function (o, l, u, i) {
        a[a.length] = u ? Ht(i, zn, '$1') : l || o;
      }),
      a
    );
  },
  Wn = function (e, r) {
    var n = e,
      a;
    if ((Ye(Gt, n) && ((a = Gt[n]), (n = '%' + a[0] + '%')), Ye(Pe, n))) {
      var o = Pe[n];
  ...
  Mt = function (e, r) {
    ...
    for (var p = 1, y = !0; p < n.length; p += 1) {
      ...
      if (((f === 'constructor' || !y) && (i = !0), (a += '.' + f), (l = '%' + a + '%'), Ye(Pe, l)))
        u = Pe[l];
      else if (u != null) {
        if (!(f in u)) {
          if (!r)
...
var jn = gr.exports,
  ...
  eo = String.prototype.toUpperCase,
...
function tr(t, e) {
  ...
  if (typeof t == 'number') {
    ...
    if (n !== t) {
      var a = String(n),
        o = Ft.call(e, a.length + 1);
      return _e.call(a, r, '$&_') + '.' + _e.call(_e.call(o, /([0-9]{3})/g, '$&_'), /_$/, '');
    }
  }
...
var bt = Kr,
  ...
  ro = function t(e, r, n, a) {
    ...
    var l = be(o, 'customInspect') ? o.customInspect : !0;
    ...
    function f(Q, se, he) {
      if ((se && ((a = to.call(a)), a.push(se)), he)) {
        var C = { depth: o.depth };
        return be(o, 'quoteStyle') && (C.quoteStyle = o.quoteStyle), t(Q, C, n + 1, a);
      }
      return t(Q, o, n + 1, a);
    }
    ...
    if (go(e)) {
      for (
        ...
        P += ' ' + w[x].name + '=' + Ar(no(w[x].value), 'double', o);
      return (
        (P += '>'),
    ...
    if (_t(e)) {
      ...
      var U = je(e, f);
      return y && !_o(U) ? '[' + St(U, y) + ']' : '[ ' + ce.call(U, ', ') + ' ]';
    }
    if (ao(e)) {
      var le = je(e, f);
    ...
    if (mo(e)) {
      ...
      return (
        ...
        ar('Set', tt.call(e), oe, y)
      );
    }
    if (yo(e)) return pt('WeakMap');
    if (ho(e)) return pt('WeakSet');
    if (vo(e)) return pt('WeakRef');
    if (lo(e)) return ke(f(Number(e)));
    if (uo(e)) return ke(f(ht.call(e)));
    if (so(e)) return ke(Kn.call(e));
    if (io(e)) return ke(f(String(e)));
    if (!oo(e) && !or(e)) {
      var K = je(e, f),
...
function Or(t, e) {
  ...
  var a = _e.call(_e.call(t, /(['\\])/g, '\\$1'), /[\x00-\x1f]/g, bo);
  return Ar(a, 'single', e);
}
function bo(t) {
  var e = t.charCodeAt(0),
    r = { 8: 'b', 9: 't', 10: 'n', 12: 'f', 13: 'r' }[e];
  return r ? '\\' + r : '\\x' + (e < 16 ? '0' : '') + eo.call(e.toString(16));
}
function ke(t) {
  return 'Object(' + t + ')';
}
...
function je(t, e) {
  ...
  if (r) {
    n.length = t.length;
    for (var a = 0; a < t.length; a++) n[a] = be(t, a) ? e(t[a], t) : '';
  }
  var o = typeof ft == 'function' ? ft(t) : [],
    l;
  if (Me) {
    l = {};
  ...
  if (typeof ft == 'function')
    for (var s = 0; s < o.length; s++)
      wr.call(t, o[s]) && n.push('[' + e(o[s]) + ']: ' + e(t[o[s]], t));
  return n;
}
var kt = Mt,
  Fe = Gn,
  ...
  qe = kt('%WeakMap%', !0),
  Ge = kt('%Map%', !0),
  $o = Fe('WeakMap.prototype.get', !0),
  Po = Fe('WeakMap.prototype.set', !0),
  Oo = Fe('WeakMap.prototype.has', !0),
  Eo = Fe('Map.prototype.get', !0),
  Co = Fe('Map.prototype.set', !0),
  xo = Fe('Map.prototype.has', !0),
  Nt = function (t, e) {
  ...
  Fo = function () {
    var e,
      ...
      a = {
        assert: function (o) {
          if (!a.has(o)) throw new Ao('Side channel does not contain ' + wo(o));
        },
        get: function (o) {
    ...
    return (
      ...
      Ae(e) && Ae(r)
        ...
        : Object.keys(r).reduce(function (o, l) {
            var u = r[l];
            return yt.call(o, l) ? (o[l] = t(o[l], u, n)) : (o[l] = u), o;
          }, a)
    );
  },
  Bo = function (e, r) {
  ...
  vt = {},
  Zo = function t(e, r, n, a, o, l, u, i, s, p, y, f, g, m, b, P) {
    ...
    if (
      ...
      if (o) return u && !m ? u(r, Y.encoder, b, 'key', f) : r;
      w = '';
    }
    if (Ko(w) || He.isBuffer(w)) {
      if (u) {
        var oe = m ? r : u(r, Y.encoder, b, 'key', f);
        return [g(oe) + '=' + g(u(w, Y.encoder, b, 'value', f))];
      }
    ...
    for (var T = a && de(w) && w.length === 1 ? r + '[]' : r, N = 0; N < ee.length; ++N) {
      var I = ee[N],
  ...
  Yo = function (e) {
    ...
    if (typeof e.format != 'undefined') {
      if (!Ho.call(Ve.formatters, e.format)) throw new TypeError('Unknown format option provided.');
      n = e.format;
    }
  ...
  oa = function (e, r) {
    ...
    if (r.charsetSentinel)
      for (i = 0; i < l.length; ++i)
        l[i].indexOf('utf8=') === 0 &&
          (l[i] === na ? (s = 'utf-8') : l[i] === ra && (s = 'iso-8859-1'),
          (u = i),
          (i = l.length));
    for (i = 0; i < l.length; ++i)
      if (i !== u) {
        ...
        f === -1
          ...
          m && r.interpretNumericEntities && s === 'iso-8859-1' && (m = ta(m)),
          p.indexOf('[]=') > -1 && (m = ea(m) ? [m] : m),
  ...
  ia = function (e, r, n, a) {
    if (e) {
      ...
      return i && p.push('[' + o.slice(i.index) + ']'), aa(p, r, n, a);
    }
  },
  la = function (e) {
    if (!e) return G;
  ...
  sa = function (t, e) {
    ...
    for (
      var n = typeof t == 'string' ? oa(t, r) : t,
  ...
  ca = sa,
  fa = Rt,
  pa = { formats: fa, parse: ca, stringify: ua };
const da = fr(pa),
  Tr = (t) => {
    const e = ze(),
      r = Qe(),
      n = (i) =>
        `${i.path}${i.query && Object.keys(i.query).length ? '?' + da.stringify(i.query) : ''}`,
      a = (i) => {
  ...
  ya = (t) => {
    const { onFresh: e, removeTab: r, closeTabsRoute: n, setTabPaneKey: a } = Tr(t),
      o = Zr([
      ...
      f = (P, w) => {
        const x = t.value.find((U) => a(U) === a(P));
        x &&
          (m(),
          y(x),
          (s.value = x),
  ...
  ma = { class: 'tabs-container' },
  ha = ['onClick', 'onContextmenu'],
  ga = ['onClick'],
  ba = { key: 0, class: 'right-button' },
  _a = J({
    __name: 'index',
    setup(t) {
      const { appConfig: e, setAppConfigMode: r } = ie(),
        n = ze(),
        a = Qe(),
        { multiTabs: o, MultiTabsDropReordering: l } = fe(),
        u = Se(() => o),
        {
          visible: i,
          rightClickTags: s,
      ...
      const x = (T) => {
        ...
        U = (T) => {
          a.push({ path: T.path, query: T.query });
        },
        le = () => {
                                    ...
                                    return [
                                      A(
                                        'div',
                                        {
                                          ...
                                          onClick: (d) => U(C),
                                          onContextmenu: dr((d) => oe(C, d), ['prevent']),
                                        },
                                        null,
                                        40,
                                        ha,
...
const Sa = me(_a, [['__scopeId', 'data-v-b7293103']]);
var Ue = { exports: {} },
  Fr = {},
  wa = function (e) {
    return (
...
(function (t) {
  ...
  function i(c, d, v) {
    ...
    if (R.length === 0) {
      ...
      if (oe(d)) return c.stylize(RegExp.prototype.toString.call(d), 'regexp');
    ...
    if (
      (oe(d) && (q = ' ' + RegExp.prototype.toString.call(d)),
...
B.relative = function (t, e) {
  ...
  if (i == 0) return e;
  for (var p = [], s = i; s < o.length; s++) p.push('..');
      ...
      return (r, n) => (
        ...
        E(
          ...
          [
            ...
            e.title ? (_(), E('span', xa, L(h(Je)(e.title)), 1)) : re('', !0),
          ],
          64,
        )
      );
...
const $t = me(Ma, [['__scopeId', 'data-v-88de4eab']]),
  Rr = J({
    __name: 'Link',
    ...
    setup(t) {
      ...
      return (o, l) => (
        _(),
        V(cr(n.value), tn(rn(a(t.to))), { default: O(() => [en(o.$slots, 'default')]), _: 3 }, 16)
      );
    },
  }),
  Ia = { key: 0 },
  Ta = J({
    ...
    setup(t) {
      const e = t,
        ...
        a = (o) => (mt(o) ? o : mt(e.basePath) ? e.basePath : Ca.resolve(e.basePath, o));
      return (o, l) => {
        var p, y;
      ...
      const e = ze(),
        r = (a) => {
          ...
          return (
            a.children &&
              a.children.length &&
              !((l = a.children[0].meta) != null && l.hideSidebar) &&
              (o = a.children[0].path),
            o
          );
        },
  ...
  Vr = (t) => (Et('data-v-5f4c2c40'), (t = t()), Ct(), t),
  ka = { class: 'color-list' },
  Na = ['onClick'],
  Ra = { class: 'options' },
  Da = { class: 'options' },
  Va = Vr(() => A('span', null, '灰色模式', -1)),
  Ba = { class: 'options' },
  Ua = Vr(() => A('span', null, '色弱模式', -1)),
  za = J({
    __name: 'index',
    setup(t) {
      const { appConfig: e, setAppConfigMode: r } = ie(),
...
const La = me(za, [['__scopeId', 'data-v-5f4c2c40']]),
  Wa = { class: 'options' },
  ja = { class: 'options' },
  qa = { class: 'options' },
  Ga = { class: 'options' },
                                ...
                                default: O(() => [
                                  A(
                                    'div',
                                    {
                                      class: Te([
                                        'sidebar_mode cursor',
                                        { 'sidebar_mode-select': h(a).sidebarMode === b.value },
                                      ]),
                                      onClick: (P) => u(b.value),
                                    },
                                    ai,
  ...
  ci = ['onClick'],
    ...
    setup(t) {
      ...
      const { multiTabs: e } = fe(),
        ...
        l = () => {
          const y = [];
          Pt(n.currentRoute.value.matched[1].path || '', o || []).forEach((m) => {
            m !== '/' && y.push(Ot(m, o || []));
          });
          const g = e.find((m) => {
            let b = {};
            return (
              ...
              y.find((P) => P.path === m.path)
                ? !1
                : a.name === m.name && ln(a.query, b) && a.path === m.path
            );
          });
          g && y.push(g),
                ...
                [
                  ...
                  A('div', Si, [
                    S(
                      ...
                      {
                        default: O(() => [
                          S(ye, { class: 'cursor', name: n.value, onClick: a }, null, 8, ['name']),
                        ]),
                        _: 1,
                      },
                      8,
...
const Ci = { class: 'app-wrapper' },
  ...
  Vi = J({
    __name: 'index',
    setup(t) {
      return (e, r) => (_(), E('div', Ci, [S(Ei), A('div', xi, [S($i), S(Sa), S(bn)])]));
    },
  });
