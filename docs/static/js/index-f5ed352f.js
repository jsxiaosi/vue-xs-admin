...
function y(e, l) {
  const { width: a, height: p, rotate: r, fontSize: c, fillStyle: i, textAlign: o } = l || {},
...
const T = {
    ...
    updated(e, l, a, p) {
      const { oldValue: r, value: c } = l;
      if (r !== c) {
        const i = e.querySelector('.water-mark');
        i && (i.style.background = `url(${y(c)}) left top repeat`);
      }
    },
  },
  j = { class: 'config' },
          ...
          $('div', null, [
            h('div', j, [
              ...
              u(
                ...
                {
                  append: m(() => [u(_, { onClick: c }, { default: m(() => [s('确定')]), _: 1 })]),
                  _: 1,
                },
                8,
                ['modelValue'],
...
const J = A(P, [['__scopeId', 'data-v-409b1bec']]);
export { J as default };
